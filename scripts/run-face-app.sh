...
exec env FACE_AUDIO_TARGET="$AUDIO_TARGET" FACE_UI_MODE="$UI_MODE" FACE_OPERATOR_PANEL_ENABLED="${FACE_OPERATOR_PANEL_ENABLED:-0}" MH_TTS_CHUNK_MAX_CHARS="${MH_TTS_CHUNK_MAX_CHARS:-64}" node face-app/dist/index.js
