...
: "${MH_BRIDGE_TERMINAL_BATCH_DELAY_MS:=500}"
: "${MH_BRIDGE_TERMINAL_BATCH_MAX_BYTES:=16384}"
: "${MH_BRIDGE_TERMINAL_RESTART_DELAY_MS:=750}"
# These polling settings are used only when MH_BRIDGE_TERMINAL_TRANSPORT=snapshot.
...
exec env \
  ...
  MH_BRIDGE_TERMINAL_TRANSPORT="$MH_BRIDGE_TERMINAL_TRANSPORT" \
  MH_BRIDGE_TERMINAL_SCROLLBACK="$MH_BRIDGE_TERMINAL_SCROLLBACK" \
  MH_BRIDGE_TERMINAL_BATCH_DELAY_MS="$MH_BRIDGE_TERMINAL_BATCH_DELAY_MS" \
  MH_BRIDGE_TERMINAL_BATCH_MAX_BYTES="$MH_BRIDGE_TERMINAL_BATCH_MAX_BYTES" \
  MH_BRIDGE_TERMINAL_RESTART_DELAY_MS="$MH_BRIDGE_TERMINAL_RESTART_DELAY_MS" \
