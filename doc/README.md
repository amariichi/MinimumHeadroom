...
- [Generic Browser Media Integration](guides/generic-browser-media.md#english) ([日本語](guides/generic-browser-media.md#japanese)) - Build a source-agnostic third-party MP3 producer/controller integration, including diagrams, HTTP/MCP contracts, iPhone/iPad behavior, security, and optional TTS focus.
...
- [汎用ブラウザメディア連携](guides/generic-browser-media.md#japanese) ([English](guides/generic-browser-media.md#english)) - 第三者MP3配信元／コントローラーを接続するための構成図、HTTP/MCP契約、iPhone/iPad挙動、セキュリティ、任意TTSフォーカス。
